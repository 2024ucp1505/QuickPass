    ...
    <div className="flex min-h-screen bg-background">
      ...
      >
        ...
        <button
          ...
          className="hidden md:flex p-12 text-white text-opacity-40 hover:text-white transition-colors items-center justify-center border-t border-white border-opacity-5"
        >
